...
export const DEFAULT_SETTINGS = {
  ...
  tagline: 'Pecel sedap bumbu meresap, sekali suap pasti mantap.',
  // Dipakai buat cuplikan di hasil pencarian Google (beda dari tagline yang tampil
  // di halaman) — kalau dikosongkan, tagline dipakai sebagai cadangan (lihat app/layout.js).
  metaDescription:
    'Pecel segar dengan sambal gurih yang bikin nambah! Sedia juga soto ayam, karedok, dan aneka gorengan renyah. Pesan online via WhatsApp sekarang.',
